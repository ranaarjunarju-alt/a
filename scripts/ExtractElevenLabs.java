 ...
 public static void main(String[] argv) throws Exception {
  ...
  try (JadxDecompiler jadx = new JadxDecompiler(args)) {
   ...
   for (JavaClass cls : jadx.getClasses()) {
    ...
    if (name.equals("com.vega.materialgenerate.TtsApiServiceManager") || name.equals("com.vega.materialgenerate.TtsApiService") || name.equals("com.vega.core.net.Response") || name.contains("ElevenLabs") || (name.startsWith("com.vega.audio.tone.tts.") && extras.contains(cls.getName()))) {
